					...
					this.loadTrack = function(source, callback) {
						...
						if (this.readyState === captionator.TextTrack.LOADED) {
							...
							if (this.type.match(/^jsonp\//)) {
				                captionator.getJSONP('http://www.universalsubtitles.org/api/1.0/subtitles/?video_url=http://www.youtube.com/watch?v=_VxQEPw1x9E&callback=?', "captionator.JSONPcallback");
							} else {
